...
public class UiManager : MonoBehaviour
{
	...
	void Awake ()
	{
		...
		Debug.Assert (cameraControl && startScreen && pauseMenu && defeatMenu && victoryMenu && levelUI && goldAmount, "Wrong initial parameters");
	}
	...
	void OnEnable ()
	{
		...
		EventManager.StartListening ("ShowStartWave", ShowStartWave);
	}
	...
	void OnDisable ()
	{
		...
		EventManager.StopListening ("ShowStartWave", ShowStartWave);
	}
	...
	void StartTimeWave ()
	{
		...
		EventManager.TriggerEvent ("StartTimeWave", null, "false");
		EventManager.TriggerEvent ("ShowTimer", null, "true");
	}

	private void ShowStartWave (GameObject obj, string param)
	{
		startWave.SetActive (Convert.ToBoolean (param));
	}
}
